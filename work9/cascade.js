...
function createOpation (obj,data){
     for (var i in data) {
 ...
 createOpation(collegeSelect,colleges)

 var majorSelect =document.getElementById('majorSelect')
 collegeSelect.onchange = function() {
    majorSelect.options.length = 0
    createOpation(majorSelect,majors[collegeSelect.value])
 ...
 majorSelect.onchange = function() {
    classSelect.options.length = 0
    createOpation(classSelect,classes[collegeSelect.value][majorSelect.value])
 }
